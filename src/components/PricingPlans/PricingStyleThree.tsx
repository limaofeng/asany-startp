...
class PricingStyleThree extends Component {
  openTabSection = (evt: React.MouseEvent, tabNmae: string) => {
    let i, tabcontent: HTMLCollectionOf<Element>, tablinks;
    ...
    (document.getElementById(tabNmae) as HTMLElement).style.display = 'block';
